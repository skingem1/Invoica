...
function loadPlanContext(projectRoot: string): string {
  const planFiles = [
    path.join(projectRoot, '..', 'Documents', 'Invoica', 'plans', 'PHASE_1_EXECUTION_PLAN.md'),
    path.join(projectRoot, '..', 'Documents', 'Invoica', 'plans', 'FULL_WORK_PLAN.md'),
  ];
...
export async function requestCTOApproval(
  ...
  projectRoot: string,
  product: 'kognai' | 'invoica' = 'invoica'
